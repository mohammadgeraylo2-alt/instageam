#!/usr/bin/env python3
"""
همه‌کاره‌ی سرور Xray روی Railway - یه فایل به‌جای سه تا:
  python3 app.py render        -> ساخت config.json زنده از قالب + clients.json
  python3 app.py manage        -> اجرای API مدیریتی (پورت 8081) برای ساخت کاربر جدید
  python3 app.py quota-check   -> یه بار چک حجم/انقضا و حذف کاربرای منقضی/تموم‌شده
"""
import json
import os
import subprocess
...
# قالب پایه‌ی کانفیگ Xray - clients همیشه خالیه، موقع render پر میشه
CONFIG_TEMPLATE = {
